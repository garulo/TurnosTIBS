...
public class EditarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtEditarUVent = request.getParameter("txtEditarUVent");
        String txtEditarUEstatus = request.getParameter("txtEditarUEstatus");
        String txtusredit = request.getParameter("txtusredit");
        Consultas co = new Consultas();
        if(co.editarUsuario(txtEditarUId,txtEditarUUsu,txtEditarUNombre,txtEditarUPass,txtEditarUEmail,txtEditarUVent,txtEditarUEstatus,txtusredit)){
