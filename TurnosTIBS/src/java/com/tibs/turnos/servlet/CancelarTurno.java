...
public class CancelarTurno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idCancelTurn = request.getParameter("idCancelTurn");
        
        System.out.println("idCancelTurn :::"+idCancelTurn);
        
        Consultas cos = new Consultas();
        Turno t = cos.consultarTurno(idCancelTurn);
        
      
        Consultas co = new Consultas();
        if(co.cancelarTurno(t)){
